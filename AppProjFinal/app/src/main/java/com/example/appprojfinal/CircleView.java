...
/*
        ...
        try {
            defaultColor = typedArray.getColor(R.styleable.circleloader_default_color,getResources().getColor(R.color.default_color));
            loaderColor = typedArray.getColor(R.styleable.circleloader_loader_color,getResources().getColor(R.color.loader_color));
            loaderLength = typedArray.getInt(R.styleable.circleloader_loader_length,defaultLoaderLength);
            animDuration = typedArray.getInt(R.styleable.circleloader_anim_duration,defaultAnimDuration);
        }catch (Exception e){
            e.printStackTrace();
        }
        typedArray.recycle();*/
